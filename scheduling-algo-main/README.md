...
* ⏳ **Waiting Time** – The duration a process spends in the queue before execution.
...
**📝 Input:**
![Input Example](https://github.com/user-attachments/assets/0ec9d846-96f5-4565-be7d-0f1fd7b29b76)

**🔍 Visualization Process:**
![Visualization Process](https://github.com/user-attachments/assets/45ac42d7-61e2-4d06-839d-5e40ed9c5baf)

**📈 Gantt Chart Representation:**
![Gantt Chart](https://github.com/user-attachments/assets/d25843ab-0d43-4dfd-aab5-781e453f7e68)

**📤 Output:**
![Output Example](https://github.com/user-attachments/assets/79384484-f0a4-4389-8205-7e06945e844c)
...
1. **📌 Clone the repository:**
   ...
   ```bash
   git clone https://github.com/aditibh19/Scheduling-Algo.git
   cd scheduling-algo
   ```
